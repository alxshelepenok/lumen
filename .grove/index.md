...
| G-11 | Theme storage key drops the diesel prefix | count; current=1 target=1 | verified |
...
| W-22 | refactor | Rename the theme storage key off the diesel prefix | G-11 | clear | ⊤ | done |  |
...
graph TD
  ...
  W_22["W-22: Rename the theme storage key off the diesel prefix"]:::done
  W_23["W-23: Strip code comments"]:::feature,critical
