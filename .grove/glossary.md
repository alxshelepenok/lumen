...
| contributors-table | The README section generated by internal/contributors.py from the GitHub contributors endpoint: six avatar cells per row between marker comments, bot accounts filtered. | D-41 |
